...
export const WeatherWidget = () => {
  ...
  if (loading) return (
    <div className="flex items-center gap-3 px-6 py-4 border border-white/5 bg-white/[0.02] rounded-sm">
      ...
      <span className="mono text-[10px] text-white/20 uppercase tracking-widest">Scanning local atmosphere...</span>
    </div>
  );
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-1">
        <span className="mono text-[10px] text-primary font-bold uppercase tracking-[4px]">Atmosphere Node</span>
        <div className="flex items-center gap-2">
          <WeatherIcon />
          <span className="display text-3xl font-black text-white">{weather.temp}°C</span>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-0.5">
        <span className="mono text-[9px] text-white/30 uppercase tracking-widest">{weather.location}</span>
        <span className="display text-sm font-bold text-white uppercase tracking-tighter italic">{weather.condition}</span>
      </div>
