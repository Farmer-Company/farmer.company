    ...
    if (this.state.hasError) {
      return (
        <div className="flex flex-col items-center justify-center min-h-[400px] p-8 text-center bg-red/5 border border-red/20 rounded-none">
          <h2 className="display text-2xl font-semibold text-red mb-4">Something went wrong.</h2>
          ...
          <button
            ...
            className="mt-6 px-6 py-2 bg-red text-white mono text-xs uppercase tracking-widest hover:bg-red/90 transition-colors"
          >
            Try again
          </button>
        </div>
