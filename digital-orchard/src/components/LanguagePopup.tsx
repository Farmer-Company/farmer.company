        ...
        >
          ...
          <div className="space-y-4">
            <div className="flex flex-col gap-1">
              <span className="text-[10px] font-black text-primary uppercase tracking-[3px]">Region Detected</span>
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 bg-primary text-black text-[10px] font-black uppercase tracking-[2px] py-2.5 hover:bg-white transition-colors"
              >
                Switch
              </button>
              <button
                onClick={() => setIsVisible(false)}
                className="flex-1 border border-white/10 text-white text-[10px] font-black uppercase tracking-[2px] py-2.5 hover:border-white transition-colors"
              >
                Ignore
              </button>
            </div>
