...
const translations: Record<Language, Record<string, string>> = {
  ...
  hi: {
    ...
    heroSubtitle:
      "भारत के लिए प्रत्यक्ष खरीद, अनुकूलित लॉजिस्टिक्स और पारदर्शी बाज़ार प्रोटोकॉल।",
    signIn: "साइन इन करें",
  ...
  mr: {
    ...
    heroSubtitle:
      "थेट खरेदी, अनुकूल लॉजिस्टिक आणि भारतासाठी पारदर्शक मार्केटप्लेस प्रोटोकॉल.",
    signIn: "साइन इन करा",
    getStarted: "सुरू करा",
    market: "बाजार",
    prices: "किंमती",
  ...
  bn: {
    ...
    heroSubtitle:
      "ভারতের জন্য সরাসরি ক্রয়, অপ্টিমাইজড লজিস্টিক এবং স্বচ্ছ মার্কেটপ্লেস প্রোটোকল।",
    signIn: "সাইন ইন করুন",
...
export const LanguageProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  return (
    <LanguageContext.Provider
      value={{ language, setLanguage, suggestedLanguage, t }}
    >
      {children}
    </LanguageContext.Provider>
  );
