        ...
        <div className="flex flex-col items-center text-center gap-6">
          ...
          <div className="relative">
            <motion.h1 
              ...
              className="display text-5xl md:text-7xl lg:text-8xl font-black uppercase tracking-tighter text-white flex flex-col md:flex-row justify-center items-center"
            >
          ...
          >
            <p className="mono text-xs md:text-sm lg:text-base text-white/70 tracking-[0.3em] uppercase leading-relaxed font-semibold flex flex-wrap justify-center gap-x-3 md:gap-x-4">
          ...
          <div className="flex-1 relative h-full flex items-end">
            <AnimatePresence>
              <motion.span 
                ...
                className="absolute bottom-0 left-0 mono text-[10px] md:text-xs text-primary/80 uppercase tracking-widest font-bold whitespace-nowrap"
              >
                {LOADING_STEPS[stepIndex]}
              </motion.span>
            </AnimatePresence>
          </div>
          <motion.span className="mono text-[10px] md:text-xs text-white font-bold tracking-wider relative z-10 w-12 text-right font-mono tabular-nums">
            {Math.round(progress)}%
          </motion.span>
        </div>
