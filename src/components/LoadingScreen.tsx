      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full px-6 max-w-5xl">
        ...
        <div className="flex flex-col items-center text-center gap-6">
          ...
          <div className="relative">
            ...
            >
              <span className="md:mr-3 drop-shadow-[0_0_20px_rgba(255,255,255,0.1)]">
                FARMER
              </span>
              <span className="text-primary drop-shadow-[0_0_20px_rgba(29,185,84,0.2)]">
                .COMPANY
              </span>
            </motion.h1>
          </div>
          ...
          >
            <p className="mono text-xs md:text-sm lg:text-base text-white/70 normal-case leading-relaxed font-semibold flex flex-wrap justify-center gap-x-3 md:gap-x-4">
              {"The OS for Agriculture and Global Supply Chain"
                .split(" ")
                .map((word, index) => (
                  <motion.span
                    key={index}
