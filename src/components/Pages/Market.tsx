...
export const MarketPage = () => {
    ...
    try {
      ...
      if (raw) {
        ...
        if (Array.isArray(parsed)) {
          setSavedMarketIds(parsed.filter((value): value is number => typeof value === 'number'));
        }
      }
    } catch {
  ...
  const paginatedNodes = useMemo(() => {
    return filteredNodes.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage);
  ...
  const openIntentForm = (market: MarketData, type: TradeIntentType) => {
    setIntentStatus('');
    setIntentForm(
      createIntentDraft(market, type, profile?.fullName || '', user?.phoneNumber || ''),
    );
  };
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 mb-16">
          <div className="space-y-4">
            ...
            <p className="text-foreground-muted normal-case md: text-[10px] md:text-sm font-medium opacity-60 max-w-3xl">
              6,944 markets mapped across India. Use arrivals data and regional signals to identify
              trade opportunities — then confirm live quotes through the ops workflow.
            </p>
          </div>
            ...
            <div className="p-8 bg-[#080808] border border-white/5 space-y-8">
              ...
              <div className="space-y-1 pt-4">
                ...
                <div className="text-sm font-medium leading-relaxed tracking-tight text-white/60">
                  Market discovery uses verified arrivals data. Live quote confirmation happens
                  through assisted trade handling — this is by design during beta, not a limitation.
                </div>
              </div>
            ...
            <div className="p-8 border border-white/5 border-dashed bg-[#050505] flex flex-col gap-4">
              ...
              <div className="space-y-3">
                <p className="mono text-[9px] leading-relaxed text-white/40 normal-case ">
                  Market discovery uses arrivals and location coverage from the current beta
                  dataset. Live quote verification still happens through the ops desk.
                </p>
          ...
          <div className="lg:col-span-3 space-y-6">
              ...
              <div className="border border-primary/20 bg-[#070707] p-6 md:p-8 space-y-6">
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-white/55">
                      Submit the commodity, quantity, and contact details. The beta ops team can
                      verify the lead and guide the next step offline if needed.
                    </p>
                  </div>
                  <button
                    type="button"
                ...
                >
                  ...
                  <input
                    ...
                    onChange={(e) => setIntentForm({ ...intentForm, contactName: e.target.value })}
                  ...
                  <input
                    ...
                    onChange={(e) => setIntentForm({ ...intentForm, targetPrice: e.target.value })}
            ...
            {totalPages > 1 && (
              <div className="flex flex-col sm:flex-row justify-between items-center gap-8 pt-12 border-t border-white/5 mt-12">
                ...
                <div className="flex items-center gap-6 px-8 py-4 bg-[#0D0D0D] border border-white/5 rounded-sm">
                  <span className="mono text-[10px] text-white/20 normal-case ">Block</span>
            ...
            <div className="pt-12 text-center">
              <p className="mono text-[9px] text-white/20 normal-case ">
                Beta market directory — 6,944 nodes active. Assisted quote validation available for
                all markets.
              </p>
            </div>
          </div>
