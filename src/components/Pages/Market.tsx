...
import { markets, allStates, allDistricts, allTiers, stateToDistrictsMap, type MarketData } from '@/src/data/markets';
...
export const MarketPage = () => {
 ...
 setSavedIntentCount(getSavedTradeIntents().length);
    ...
    const districts = stateFilter ? stateToDistrictsMap.get(stateFilter) || [] : allDistricts;
