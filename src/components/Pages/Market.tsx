      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 mb-16">
          <div className="space-y-4">
            ...
            <p className="text-foreground-muted uppercase tracking-[2px] md:tracking-[3px] text-[10px] md:text-sm font-bold opacity-60">
              Discover credible markets and convert interest into a real beta lead
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
          <div className="lg:col-span-1 space-y-8">
            <div className="p-8 bg-[#080808] border border-white/5 space-y-8">
              <div className="space-y-1">
                <span className="text-[10px] font-black text-white/20 uppercase tracking-[4px]">
                  Active Markets
                </span>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="mono text-[10px] text-primary">Guided</span>
                </div>
              ...
              <Button
                className="w-full bg-primary text-black font-black uppercase tracking-widest text-[10px] h-14 hover:scale-[1.02] transition-all"
            ...
            <div className="p-8 border border-white/5 border-dashed bg-[#050505] flex flex-col gap-4">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3 text-[9px] uppercase tracking-[2px]">
                  <div className="border border-white/5 px-3 py-3">
                    <span className="block text-white/20 mb-1">Saved Markets</span>
                    <span className="mono text-primary font-black text-sm">
          ...
          <div className="lg:col-span-3 space-y-6">
            <div className="flex items-center justify-between mb-4 px-2">
              <span className="text-[10px] font-black text-white/40 uppercase tracking-[4px]">
                Verified Procurement Units
              </span>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-primary animate-pulse" />
                <span className="mono text-[10px] text-primary uppercase font-black">
                      ...
                      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 relative z-10">
                        <div className="space-y-5 flex-1">
                          <div className="flex items-center gap-4">
                            <span className="px-2 py-0.5 bg-primary/10 text-primary mono text-[9px] font-black uppercase border border-primary/20 tracking-widest">
                              Node Online
                            </span>
                            <span className="mono text-[10px] text-white/20 uppercase tracking-[3px]">
                          ...
                          <div className="flex flex-wrap gap-x-10 gap-y-6">
                            <div className="flex items-center gap-3">
                              ...
                              <div className="flex flex-col">
                                ...
                                <span className="mono text-[9px] text-white/20 uppercase">
                                  {market.State}
                                </span>
                              </div>
                            </div>
                        ...
                        <div className="flex items-center gap-6 w-full md:w-auto pt-6 md:pt-0 border-t md:border-t-0 border-white/5">
                          <div className="flex-1 md:text-right space-y-2">
                            <div className="text-[10px] font-black text-primary uppercase tracking-[2px]">
                              Trade Signal
                            </div>
                            ...
                            <div className="mono text-[9px] uppercase tracking-[2px] text-white/25">
                          ...
                          <div className="flex gap-3">
                            ...
                            <Button
                              className="h-14 bg-white text-black font-black uppercase tracking-[3px] text-[10px] px-8 hover:bg-primary transition-all hover:translate-x-1 active:scale-95 shadow-xl"
              ...
              <div className="border border-primary/20 bg-[#070707] p-6 md:p-8 space-y-6">
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                  <div className="space-y-2">
                    <div className="flex items-center gap-2 text-primary">
                      <PhoneCall size={16} />
                      <span className="mono text-[10px] uppercase tracking-[3px] font-black">
                  ...
                  <button
                    ...
                    className="text-[10px] uppercase tracking-[3px] text-white/40 hover:text-white transition-colors"
                  >
                    Close
                  </button>
                </div>
                ...
                <form onSubmit={handleIntentSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <input
                    ...
                    className="h-14 px-4 bg-black border border-white/10 focus:border-primary outline-none mono text-xs uppercase tracking-widest"
                  />
                  <input
                    required
                    type="number"
                  ...
                  <div className="md:col-span-2 flex flex-col md:flex-row md:items-center md:justify-between gap-4 pt-2">
                    ...
                    <Button
                      ...
                      className="h-14 bg-primary text-black font-black uppercase tracking-[3px] text-[10px] px-8"
                    >
            ...
            <div className="pt-12 text-center">
              <p className="mono text-[9px] text-white/20 uppercase tracking-[4px]">
                Beta market directory. Live quotes are validated during assisted trade handling.
              </p>
            </div>
          </div>
        </div>
