      ...
      <div className="max-w-4xl mx-auto space-y-16">
        <div className="space-y-6">
          ...
          <div className="text-foreground-muted space-y-4 text-[17px] leading-[1.47] max-w-3xl">
            <p className="font-semibold text-white">
              Verified price intelligence across 2,487 active markets — in active integration.
            </p>
            <p>
              We're connecting Agmarknet and TN Agmark feeds for real-time, timestamped, validated
              rupee prices across every commodity. Until source integration is complete for your
              commodity and region, exact prices stay hidden — we don't publish unverified data.
            </p>
          ...
          {submitted ? (
            <div className="text-center py-12 space-y-4">
              ...
              <p className="text-white/60 text-[17px]">
                We'll notify {email} when {selectedCommodity} data goes live in {selectedState}.
              </p>
            </div>
          ) : (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  >
                    ...
                    {commodities.map((c) => (
                      <option key={c.code} value={c.name} className="bg-[#0D0D0D]">
                        {c.name} ({c.code})
                      </option>
                    ))}
                  </select>
        ...
        <div className="space-y-8">
          <p className="text-[17px] text-foreground-muted leading-[1.47]">
            You'll receive a notification when verified price data goes live for your selection.
            <br />
            <span className="text-white mt-2 inline-block">
              Currently in active integration: Tamil Nadu (pilot region) — coconut, tomato, onion,
              banana.
            </span>
          </p>
          ...
          <p className="mono text-[9px] text-white/40 normal-case leading-relaxed italic">
            *Pilot integration means data is being validated against source timestamps before
            publishing. We publish nothing unverified.
          </p>
        </div>
      </div>
    </div>
