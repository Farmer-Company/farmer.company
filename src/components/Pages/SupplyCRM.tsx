  ...
  return (
    <div className="pt-24 pb-20 px-6 min-h-screen bg-background">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-10">
          <div className="space-y-6 max-w-2xl">
            <div className="flex items-center gap-3">
              ...
              <span className="text-white/20 mono text-[10px]">
                Institutional Grade
              </span>
            </div>
            ...
            <p className="text-foreground-muted text-lg md:text-xl font-light leading-relaxed">
              Manage your farm as a global supply node. Direct contracting,
              trade finance, compliance, and multi‑buyer relationship management
              – all in one protocol.
            </p>
      ...
      <section className="max-w-7xl mx-auto mb-20 grid grid-cols-2 md:grid-cols-4 gap-px bg-white/5 border border-white/5 overflow-hidden">
        ...
        <MetricBox
          value="12"
          label="Countries in Buyer Network"
          sub="EU, Gulf, SEA, US"
        />
        <MetricBox
          value="Institutional"
          label="Contract Standard"
          sub="Digital signatures, milestone tracking"
        />
        <MetricBox
          value="Zero"
          label="Middlemen in the Chain"
          isPrimary
          sub="Farm → Buyer direct"
        />
      </section>
      ...
      <section className="max-w-7xl mx-auto mb-32">
        <div className="flex items-center gap-4 mb-12">
          ...
          <h2 className="mono text-[10px] text-white/40 normal-case font-medium">
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            <WorkflowStep
              num="01"
              title="Onboard"
              desc="Complete export readiness profile and upload certifications."
            />
            <WorkflowStep
              num="02"
              title="Publish"
              desc="Post volume, grades, and target price to the procurement network."
            />
            <WorkflowStep
              num="03"
              title="Negotiate"
              desc="Receive institutional RFQs and settle contract terms digitally."
            />
            <WorkflowStep
              num="04"
              title="Fulfill"
              desc="Generate compliance docs and track shipment to destination."
            />
          </div>
        </div>
      </section>
      ...
      <section className="max-w-3xl mx-auto text-center py-20">
        ...
        <p className="text-foreground-muted text-lg font-light mb-10">
          Supply CRM is in private beta. We onboard verified exporters,
          large-scale farmers, and institutional buyers in cohorts. Apply below
          — we'll review your supply profile and respond within 48 hours.
        </p>
...
const MetricBox = ({ value, label, sub, isPrimary }: any) => (
  <div className="bg-[#050505] p-8 flex flex-col justify-between group hover:bg-primary/[0.02] transition-colors">
    <div className="space-y-1">
      <span
        className={`mono text-3xl font-light ${isPrimary ? "text-primary" : "text-white"}`}
      >
        {value}
      </span>
      <p className="text-[10px] font-medium text-white/40 normal-case leading-tight">
        {label}
      </p>
    </div>
    <div className="mt-4 flex items-center gap-2">
      <div
        className={`w-1 h-1 rounded-full ${isPrimary ? "bg-primary" : "bg-white/20"}`}
      />
  ...
  <div className="bg-[#050505] p-10 flex flex-col justify-between group hover:bg-[#080808] transition-all relative overflow-hidden">
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <h3 className="text-xl font-medium text-white normal-case tracking-tight">
          {title}
        </h3>
...
const WorkflowStep = ({ num, title, desc }: any) => (
  <div className="space-y-6">
    <span className="display text-6xl font-light text-white/5 leading-none">
      {num}
    </span>
    <div className="space-y-3">
      <h4 className="text-xl font-medium text-white normal-case tracking-tight">
        {title}
      </h4>
      <p className="text-sm font-light text-foreground-muted leading-relaxed">
        {desc}
