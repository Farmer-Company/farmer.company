      ...
      <div className="pt-40 flex flex-col items-center gap-8 px-6 text-center">
        <div className="space-y-4 max-w-2xl">
          ...
          <p className="text-foreground-muted leading-relaxed">
            Personalise your Digital Orchard operating environment — commodity watchlists, regional
            alerts, price threshold notifications, forecast subscriptions, and logistics route
            preferences.
          </p>
              ...
              <div className="space-y-6">
                ...
                {(role === 'government' || role === 'logistics') && (
                  <p className="text-sm text-foreground-muted italic">
                    Identifying systemic architecture parameters for public data analysis...
                  </p>
                )}
              </div>
          ...
          {step === 4 && (
            ...
            >
              ...
              <p className="text-sm text-foreground-muted font-light leading-relaxed">
                Enable global supply features and institutional offtake agreements by providing your
                export details.
              </p>
