  ...
  return (
    <div className="pt-32 px-10 min-h-screen bg-background text-white">
      ...
      <p className="text-foreground-muted normal-case text-sm leading-relaxed max-w-4xl">
        Predictive intelligence from 25 years of clean arrivals data. During beta, sample
        intelligence is shown below — live signals go active as price feed integration completes by
        region.
      </p>
      ...
      <div className="mt-8 p-4 bg-amber-500/10 border border-amber-500/20 text-amber-500 text-sm font-medium leading-relaxed mb-4">
        ⚡ DEMO INTELLIGENCE — These cards show the type of signals Digital Orchard will surface.
        Live intelligence activates region-by-region as verified price feeds come online. Tamil Nadu
        goes live first.
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              <div className="space-y-2">
                ...
                <p className="text-xs text-white normal-case ">
                  CHEAPEST: <span className="text-primary">KOLAR (₹800/q)*Sample</span>
                </p>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-white normal-case ">
                  CHEAPEST: <span className="text-primary">LASALGAON (₹1,200/q)*Sample</span>
                </p>
                <p className="text-[10px] text-red-400 normal-case tracking-tight">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-white normal-case ">
                  CHEAPEST: <span className="text-primary">KOLAR (₹600/q)*Sample</span>
                </p>
                <p className="text-[10px] text-red-400 normal-case tracking-tight">
        ...
        <div className="space-y-8">
          <div className="p-10 bg-[#080808] border border-white/10 space-y-8">
            ...
            <p className="text-[9px] text-foreground-muted normal-case leading-loose pt-4">
              Regional intelligence activates as verified price feeds come online. Tamil Nadu pilot
              is first.
            </p>
          </div>
        </div>
