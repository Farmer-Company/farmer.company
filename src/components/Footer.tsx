    ...
    <footer className="bg-[#050505] text-white py-20 px-8 md:px-12 lg:px-24 border-t border-white/5 font-sans">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-20">
          <div className="flex flex-col gap-4">
            ...
            <p className="text-xs text-white/40 normal-case font-medium">
              Operational updates, market intelligence, and supply chain
              insights from our Tamil Nadu pilot. Publishing begins Q3 2026.
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-12 mb-16">
          <div className="flex flex-col gap-6">
            <h4 className="text-[11px] font-medium normal-case text-white/90">
              About
            </h4>
        ...
        <div className="border-t border-white/5 pt-12 flex flex-col gap-10">
          <p className="text-[10px] text-white/30 leading-relaxed max-w-4xl normal-case ">
            Digital Orchard requires an active internet connection for real-time
            market data synchronization. Professional subscription features for
            large-scale operations may be subject to additional service fees.
            Access to the global marketplace is subject to local agricultural
            regulations and data integrity protocols.
            <br />
            <br />
            *Real-time updates require network access. Hardware sensors sold
            separately.
          </p>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-10">
            <div className="flex flex-col gap-6">
              ...
              <p className="text-[10px] text-white/15 leading-relaxed max-w-2xl font-medium">
                All platform content, market data, and architectural schemas are
                trademarks or copyright material of Farmer Company. All rights
                reserved.{" "}
                <a
                  href="#"
