      ...
      <div className="relative z-10 max-w-7xl w-full">
        ...
        >
          <div className="text-[17px] md:text-[24px] font-normal text-white/60 max-w-3xl leading-[1.5] space-y-4">
            <p>
              6,944 mandis. 250+ commodities. 53–67% of value lost to intermediaries before a farmer
              gets paid.
            </p>
            <p>
              Digital Orchard is the operating system that puts price intelligence, direct trade,
              and demand forecasting in the hands of every farmer — before they plant, not after
