...
export const HeroSection = () => {
 ...
 <span className="text-primary">Indian agriculture never had.</span>
 </h1>
 </div>
 </motion.div>
 ...
 <p>6,944 mandis. 250+ commodities. 53–67% of value lost to intermediaries before a farmer gets paid.</p>
 <p>Digital Orchard is the operating system that puts price intelligence, direct trade, and demand forecasting in the hands of every farmer — before they plant, not after they've already lost.</p>
 </div>
 ...
 <h3 className="text-[17px] font-medium text-white tracking-tight">Price Intelligence</h3>
 <p className="text-[14px] text-white/60 leading-[1.43]">Compare 3,000+ markets instantly</p>
 </div>
 <div className="flex flex-col gap-2 p-5 md:p-6 bg-black border border-white/5 rounded-none">
 <span className="text-xl md:text-2xl">📈</span>
 <h3 className="text-[17px] font-medium text-white tracking-tight">90-Day Forecasts</h3>
 <p className="text-[14px] text-white/60 leading-[1.43]">Know exactly when to sell</p>
 </div>
 <div className="flex flex-col gap-2 p-5 md:p-6 bg-black border border-white/5 rounded-none">
 <span className="text-xl md:text-2xl">🛒</span>
 <h3 className="text-[17px] font-medium text-white tracking-tight">Direct Marketplace</h3>
 <p className="text-[14px] text-white/60 leading-[1.43]">Sell directly without middlemen</p>
 </div>
 <div className="flex flex-col gap-2 p-5 md:p-6 bg-black border border-white/5 rounded-none">
 <span className="text-xl md:text-2xl">👨‍🌾</span>
 <h3 className="text-[17px] font-medium text-white tracking-tight">Farmer Portfolio</h3>
 <p className="text-[14px] text-white/60 leading-[1.43]">Your lifetime contribution, SKU-by-SKU</p>
 </div>
 </div>
 </motion.div>
 </div>
