...
const WeatherIcon = ({ condition }: { condition: string }) => {
 ...
 if (conditionLower.includes('clear')) return <Sun size={20} className="text-yellow-500" />;
 if (conditionLower.includes('rain')) return <CloudRain size={20} className="text-blue-500" />;
 if (conditionLower.includes('storm')) return <CloudLightning size={20} className="text-primary" />;
