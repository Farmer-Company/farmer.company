...
export const WeatherWidget = () => {
 ...
 {(() => { const condition = weather.condition.toLowerCase(); if (condition.includes('clear')) return <Sun size={20} className="text-yellow-500" />; if (condition.includes('rain')) return <CloudRain size={20} className="text-blue-500" />; if (condition.includes('storm')) return <CloudLightning size={20} className="text-primary" />; return <Cloud size={20} className="text-white/40" />; })()}
