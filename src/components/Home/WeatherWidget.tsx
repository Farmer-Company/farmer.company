...
export const WeatherWidget = () => {
 ...
 if (condition.includes('clear')) weatherIcon = <Sun size={20} className="text-yellow-500" />;
 else if (condition.includes('rain')) weatherIcon = <CloudRain size={20} className="text-blue-500" />;
 else if (condition.includes('storm')) weatherIcon = <CloudLightning size={20} className="text-primary" />;
