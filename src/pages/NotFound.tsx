    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 noise-bg relative overflow-hidden">
      ...
      >
        ...
        <div className="space-y-4 mb-12">
          <p className="mono text-xs text-red-500 font-medium normal-case ">
            Resource node not found
          </p>
          <p className="text-white/40 text-lg font-light leading-relaxed">
            The path you are attempting to access is either deprecated or does not exist within the
            Digital Orchard network.
          </p>
        </div>
