  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 noise-bg relative overflow-hidden">
      ...
      >
        ...
        <h1 className="display text-7xl md:text-9xl font-black text-white uppercase tracking-tighter leading-none mb-6">
          ERR<br />
          <span className="text-red-500">404</span>
        </h1>
        
        <div className="space-y-4 mb-12">
          <p className="mono text-xs text-red-500 font-bold uppercase tracking-[0.4em]">Resource node not found</p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
          <Button 
            className="h-14 px-8 uppercase font-black tracking-widest bg-white text-black hover:bg-white/90"
            onClick={() => navigate('/')}
          >
          ...
          <Button 
            variant="outline"
            className="h-14 px-8 uppercase font-black tracking-widest border-white/10 text-white hover:border-primary"
            onClick={() => navigate(-1)}
          >
            Go Back
          </Button>
      ...
      <div className="absolute bottom-12 left-12 hidden lg:block">
        <p className="mono text-[10px] text-white/10 uppercase tracking-[5px] leading-loose">
